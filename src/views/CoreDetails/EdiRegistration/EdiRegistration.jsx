...
function EdiRegistration(props) {
    const { classes } = props;
    const addBtn = (
        <Button color="success" onClick={()=>{handleLink('/addediregistration')}}>
            Add
      </Button>
    )
    const splitBtn = (
            ...
            <GridItem xs={12} sm={12} md={12}>
                <Card>
                    <CardHeader color="primary">
                        <h4 className={classes.cardTitleWhite}>EDI Registration</h4>
                        {/* <p className={classes.cardCategoryWhite}>Here is a subtitle for this table</p> */}
                    </CardHeader>
                    <CardBody>
                        <Table
                            tableHeaderColor="primary"
                            tableHead={["Carrier Code", "State", "HIOS ID", "Trading Partner ID", "Carrier Short Name", "Actions",""]}
                            tableData={[
...
export default withStyles(styles)(EdiRegistration);
